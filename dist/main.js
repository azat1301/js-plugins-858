...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "connect",
    value: function connect() {// console.log('Hello from disable_button_controller.js')
  ...
  _createClass(_default, [{
    ...
    value: function fetchOMDbAPI(keyword) {
      ...
      fetch(url).then(function (response) {
        ...
        _this.displayMovie(movies);
      });
    }
  }, {
    key: "searchMovie",
    value: function searchMovie(event) {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "connect",
    value: function connect() {
      sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(this.element, {
        ghostClass: "ghost",
        animation: 1500
      });
    }
